...
public class Packager
{
    ...
    static UnityEngine.Object LoadAsset(string file)
    {
        ...
        return AssetDatabase.LoadMainAssetAtPath("Assets/_Scripts/FrameWork/Examples/Builds/" + file);
    }

    [MenuItem("MyFrameWork/Build iPhone Resource", false, 100)]
    ...
    [MenuItem("MyFrameWork/Build Android Resource", false, 101)]
    public static void BuildAndroidResource()
    {
        BuildAssetResource(BuildTarget.Android);
    }

    [MenuItem("MyFrameWork/Build Windows Resource", false, 102)]
    ...
    public static void BuildAssetResource(BuildTarget target)
    {
        ...
        {
            HandleBundle();
            if(AppConst.PrefabBundleMode)
                CreateResIniFile.BuildLayoutAll();
        }
        else
        {
            HandleLuaFile();
    ...
    static void HandleBundle()
    {
        ...
        string[] luaPaths = { AppDataPath + "/_Scripts/FrameWork/lua/",
                              AppDataPath + "/_Scripts/FrameWork/Tolua/Lua/" };
...
//            string ext = Path.GetExtension(file);
    ...
    [MenuItem("MyFrameWork/Build Protobuf-lua-gen File")]
    public static void BuildProtobufFile()
    {
        string dir = AppDataPath + "/../../../proto/proto/";
        paths.Clear(); files.Clear(); Recursive(dir);

        string protoc = AppDataPath + "/../../../proto/protobuf-2.4.1/src/protoc.exe";
        string protoc_gen_dir = "\""+ AppDataPath + "/../../../proto/protoc-gen-lua/plugin/protoc-gen-lua.bat\"";
        ...
        foreach (string f in files)
        {
            ...
            info.Arguments = " --lua_out=./../../NewClient/NewThreeMonth/Assets/_Scripts/FrameWork/Lua/3rd/pblua/ --plugin=protoc-gen-lua=" + protoc_gen_dir + " " + name;
