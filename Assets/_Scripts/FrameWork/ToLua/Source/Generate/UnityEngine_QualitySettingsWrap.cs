...
public class UnityEngine_QualitySettingsWrap
{
	...
	static int SetQualityLevel(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.QualitySettings.SetQualityLevel");
			}
		}
		catch(Exception e)
		{
	...
	static int IncreaseLevel(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.QualitySettings.IncreaseLevel");
			}
		}
		catch(Exception e)
		{
	...
	static int DecreaseLevel(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.QualitySettings.DecreaseLevel");
			}
		}
		catch(Exception e)
		{
