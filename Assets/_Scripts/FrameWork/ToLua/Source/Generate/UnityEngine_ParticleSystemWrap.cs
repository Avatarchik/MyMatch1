...
public class UnityEngine_ParticleSystemWrap
{
	...
	static int Simulate(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.ParticleSystem.Simulate");
			}
		}
		catch(Exception e)
		{
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.ParticleSystem.Play");
			}
		}
		catch(Exception e)
		{
	...
	static int Stop(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.ParticleSystem.Stop");
			}
		}
		catch(Exception e)
		{
	...
	static int Pause(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.ParticleSystem.Pause");
			}
		}
		catch(Exception e)
		{
	...
	static int Clear(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.ParticleSystem.Clear");
			}
		}
		catch(Exception e)
		{
	...
	static int IsAlive(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.ParticleSystem.IsAlive");
			}
		}
		catch(Exception e)
		{
