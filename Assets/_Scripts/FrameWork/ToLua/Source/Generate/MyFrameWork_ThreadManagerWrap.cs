...
public class MyFrameWork_ThreadManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MyFrameWork.ThreadManager), typeof(Manager));
		L.RegFunction("AddEvent", AddEvent);
		L.RegFunction("New", _CreateMyFrameWork_ThreadManager);
	...
	static int _CreateMyFrameWork_ThreadManager(IntPtr L)
	{
		return LuaDLL.tolua_error(L, "MyFrameWork.ThreadManager class does not have a constructor function");
	}
