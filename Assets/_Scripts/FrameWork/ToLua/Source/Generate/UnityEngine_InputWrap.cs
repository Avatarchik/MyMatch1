...
public class UnityEngine_InputWrap
{
	...
	static int GetKey(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.Input.GetKey");
			}
		}
		catch(Exception e)
		{
	...
	static int GetKeyDown(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.Input.GetKeyDown");
			}
		}
		catch(Exception e)
		{
	...
	static int GetKeyUp(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.tolua_error(L, "invalid arguments to method: UnityEngine.Input.GetKeyUp");
			}
		}
		catch(Exception e)
		{
