...
namespace MyFrameWork {
    public class LuaBehaviour : Base {
        ...
        public void InvokeTesting()
        {
            Debug.Log("InvokeTesting!!!!!!!!!!");
        }
        ...
        public void OnInit(AssetBundle bundle, string text = null) {
			...
			DebugUtil.Info("OnInit---->>>" + name + " text:>" + text);
        }
        ...
        public void AddClick(GameObject go, LuaFunction luafunc) {
            ...
            if(buttons.ContainsKey(go.name)== false)
            {
        ...
        public void ReadPhoto()
        {
            ...
            GameObject.Find("T_Photo").GetComponent<UITexture>().mainTexture = Resources.Load("Photos/" + 23 % 6) as UnityEngine.Texture;
