/*******************************************************
 * 
 * 文件名(File Name)：             Lightning
 *
 * 作者(Author)：                  http://www.youkexueyuan.com
 *								  XiaoHong 
 *                                Yangzj
 *
 * 创建时间(CreateTime):           2016/04/24 15:29:46
 *
 *******************************************************/
...
namespace Fight
{
	...
	//		line.sortingOrder = sortingOrder;
		...
		public static Lightning CreateLightning (int bend, Transform start, Transform end, Color color) {
			Lightning newLightning = ResourceMgr.Instance.LoadAndInstanceGameObjectFromPreload("Lightning").GetComponent<Lightning>();
