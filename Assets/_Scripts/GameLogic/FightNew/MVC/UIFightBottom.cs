...
namespace FightNew
{
	public class SkillDataOld
	{
		...
		public SkillDataOld(int id,string spriteName,int energy)
		{
			Id = id;
	...
	public class UIFightBottom : MonoBehaviour 
	{
		...
		//技能
		private Dictionary<int,SkillDataOld> _dicSkillData;
...
//		}
		...
		private SkillDataOld FindNotUsedSkill()
		{
			for(int i = 0;i < _listSkillId.Count;i++)
			{
