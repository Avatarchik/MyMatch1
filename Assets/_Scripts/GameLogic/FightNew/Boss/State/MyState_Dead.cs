...
namespace FightNew
{
	public class MyState_Dead : StateBase 
	{
//		private bool _hasEnter = false;
		public MyState_Dead(PlayerBase player):base(player)
		{
...
//			Debug.Log("<color=orange>My finish dead:</color>" + FightMgr.Instance.EffectCount);
		}
	}
}